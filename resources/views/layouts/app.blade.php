...
<body class="font-sans antialiased h-full">
    <div class="flex min-h-screen bg-slate-50/50 dark:bg-[#020617]">
        <!-- Sidebar -->
        <aside
            class="w-72 bg-white border-r border-slate-200 hidden lg:flex flex-col sticky top-0 h-screen transition-all duration-300 dark:bg-[#0f172a] dark:border-slate-800/60">
